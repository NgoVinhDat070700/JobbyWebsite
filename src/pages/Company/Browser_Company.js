...
function Browser_Company() {
  ...
  return (
    <main>
      <BannerPageTitle pageName="Browser Company Grid" />
      ...
      <SearchLeft inputText={inputText} setInputText={setInputText} onChangeInput={onChangeInput} handleSearch={handleSearch} />
        <div className="banner__container__right">
          ...
          <div className="tags__menu">
                ...
                <Company type={type} data={data} setData={setData} setType={setType} />
        </div>
      </section>
    </main>
  );
}
export default Browser_Company;
